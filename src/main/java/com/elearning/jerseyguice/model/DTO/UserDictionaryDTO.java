...
public class UserDictionaryDTO {
	...
	public String getWordIdAsString() {
        return Integer.toString(this.wordId);
	}
	...
	public UserDictionaryDTO wordId(int wordId) {
		this.wordId = wordId;
		return this;
	}
	...
	public UserDictionaryDTO createDate(Integer createDate) {
		this.createDate = createDate;
		return this;
	}
